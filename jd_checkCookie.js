...
async function isLoginByX1a0He() {
    const options = {
        ...
        headers: {
            ...
            "User-Agejd_nt": "jdapp;iPhone;10.1.2;15.0;network/wifi;Mozilla/5.0 (iPhone; CPU iPhone OS 15_0 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148;supportJDSHWK/1",
        },
        method: 'get',
    }
